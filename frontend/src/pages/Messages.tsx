...
const Messages: React.FC = () => {
  ...
  const { conversations, activeConversation, messages, isLoading, isSending, hasMoreMessages } =
  ...
  const handleLoadMore = () => {
    ...
    dispatch(fetchMessages({ conversationId: activeConversation.id, before: oldestMessageId }));
  };
