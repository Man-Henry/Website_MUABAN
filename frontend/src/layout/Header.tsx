...
const Header: React.FC = () => {
  ...
  // Sync DOM with initial dark state
  useEffect(() => {
    if (isDark) {
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="flex h-9 w-9 items-center justify-center rounded-xl text-on-surface-variant hover:bg-surface-container transition-colors active-scale"
        ...
        <div className="flex md:hidden items-center gap-1">
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="flex h-10 w-10 items-center justify-center rounded-xl text-on-surface-variant hover:bg-surface-container transition-colors cursor-pointer active-scale"
            aria-label="Toggle Dark Mode"
          >
